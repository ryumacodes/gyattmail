...
export type EmailProvider = 'gmail' | 'outlook' | 'custom' | 'agentmail'
export type AuthType = 'oauth2' | 'password' | 'api-key'
...
export type MailMutationAction =
  | 'read'
  | 'unread'
  | 'star'
  | 'unstar'
...
export interface MailMutationRequest {
  emailIds: string[]
  action: MailMutationAction
  targetFolder?: string
  addLabels?: string[]
  removeLabels?: string[]
