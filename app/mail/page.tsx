...
const AgentMailIcon = () => (
  <span title="AgentMail" className="flex size-full items-center justify-center rounded-sm bg-hat-600 font-serif font-bold text-paper-100">A</span>
)
